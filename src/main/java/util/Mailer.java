...
public class Mailer {
    private static final String FROM_EMAIL = "justtai2k7@gmail.com"; // Thay bằng email của bạn
...
//    3. Tạo một mật khẩu mới (ví dụ đặt tên là "JavaWeb") và copy mã 16 ký tự đó dán vào biến PASSWORD trong file Mailer.java.
    private static final String PASSWORD = "iisi ezug hzmy fysi";      // Thay bằng App Password của bạn
